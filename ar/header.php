        ...
        <div class="container-fluid">
            <div id="top-header" class="row is-flex top-header">
                ...
                <div class="col-md-7 col-xs-8 text-right">
                    <p>
                        اعرف أكثر عن حلولنا الرقمية المتكاملة, اتصل على
                    </p>
            ...
            <div class="container">
                <div class="row is-flex ">
                    ...
                    <ul id="main-navbar" class="nav navbar-nav collapse navbar-collapse navbar-ex1-collapse">
                        <li class="menu-item"><a itemprop="url" href="index.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">الرئيسية </a></li>
                        <li class="dropdown dropdown-submenu0">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">نماذج 
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="menu-item sub-item"><a href="template.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">مدفوع</a>
                                </li>
                                <li class="menu-item sub-item"><a href="template-free.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">مجاني</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown dropdown-submenu0">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">التجارة الإلكترونية
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="menu-item sub-item"><a href="store-standard.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">الخطة الاساسية  </a>
                                </li>
                                <li class="menu-item sub-item"><a href="store-advanced.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">الخطة المتطورة  </a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown dropdown-submenu0">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">سابقة أعمالنا 
                                <b class="caret"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="menu-item sub-item"><a href="web-design.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">تصميم المواقع</a>
                                </li>
                                <li class="menu-item sub-item"><a href="social-media-designs.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">تصميم إعلانات السوشيال ميديا</a>
                                </li>
                                <li class="menu-item sub-item"><a href="video-creation.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">صور / فيديو / 360° </a>
                                </li>
                                
                                <li class="menu-item sub-item"><a href="logo.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">تصميم لوجو </a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-item" style="order:6"><a href="contact.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">اتصل بنا</a></li>
                        
                        <li class="menu-item"><a href="../<?php echo basename($_SERVER['PHP_SELF']);?>?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>" class="">English</a></li>
                    </ul>
                        
<!--
                    <p class="lang navbar-nav navbar-right navbar-text pull-right">
                        <a href="../" class="navbar-link">English</a>
                    </p>    
-->
                    </div>
