                    ...
                    <ul id="main-navbar" class="nav navbar-nav collapse navbar-collapse navbar-ex1-collapse">
                        ...
                        <li class="dropdown dropdown-submenu0">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="menu-item sub-item"><a href="video-creation.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">صور / فيديو </a>
                                </li>
                        ...
                        <li class="menu-item"><a href="contact.php?utm_source=<?=$_REQUEST["utm_source"];?>&utm_language=<?=$_REQUEST["utm_language"];?>&utm_adname=<?=$_REQUEST["utm_adname"];?>">اتصل بنا</a></li>
