    ...
    <div class="container">
        <div class="row is-flex">
            <div class="col-lg-3 col-md-3 ">
                <div class="arrow bottom right text-right">
                    <h2 class="text-right"> ابدأ من هنا <small></small></h2>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-10 col-md-offset-1">
                <h2 class="head-message"> استفد بحلولنا الإعلانية المتنوّعة والموفرة عن طريق ملء الاستمارة أدناه.

<br>  أو استخدم أي من وسائل التواصل التالية:</h2>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 contact-data">
               <div class="row is-flex">
                <div class="col-md-4 contact-data-item">
                    <div class="col-md-12">
                        <h2 class="text-left">اتصل بنا:</h2>
                    </div>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-xs-2 ">
                            ...
                            <div class="col-xs-10">
                                <p>الرقم المختصر : <a href="tel:19345">19345 </a> </p>
                                <p>رقم الفاكس : <a href="tel:+2 02 2755 9831">+2 02 2755 9831 </a> </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-2 ">
                                <a target="_blank" rel="noopener" mob-href="https://wa.me/send?phone=201206666558" href="https://web.whatsapp.com/send?phone=201206666558"
                                style="width:24px;height:24px;margin-top:-10px;color:gray;"><svg version="1.1" id="Layer_1"
                            ...
                            <div class="col-xs-10">
                                <a target="_blank" rel="noopener" mob-href="https://wa.me/send?phone=201206666558" href="https://web.whatsapp.com/send?phone=201206666558"
                                style=""><p>خدمة العملاء عبر الواتس اب</p> </a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-2 ">
                                <a target="_blank" rel="noopener" mob-href="https://wa.me/send?phone=201206666568" href="https://web.whatsapp.com/send?phone=201206666568"
                                style="width:24px;height:24px;margin-top:-10px;color:gray;">
                            ...
                            <div class="col-xs-10">
                                <a target="_blank" rel="noopener" mob-href="https://wa.me/send?phone=201206666568" href="https://web.whatsapp.com/send?phone=201206666568"
                                style=""><p>للاعلان يرجى التواصل عبر الواتس اب برقم</p></a>
                            </div> 
                        </div>
...
-->
                ...
                <div class="col-md-4 contact-data-item">
                    <div class="col-md-12">
                        <h2 class="text-left">أو راسلنا عبر البريد الإلكتروني:</h2>
                    </div>
                    <div class="col-xs-2 ">
                        <i class="fa fa-envelope"></i>
                    </div>
                    <div class="col-xs-10">
                        ...
                        <p> <a href="mailto:customercare@Yellow.com.eg">customercare@Yellow.com.eg</a> </p>
                    </div>
                </div>
                <div class="col-md-4 contact-data-item">
                    <div class="col-md-12">
                        <h2 class="text-left">أو زرنا:</h2>
                    </div>
                    <div class="col-xs-2 ">
                    ...
                    <div class="col-xs-10">
                        <p>قطعة 6 أ/18،
                            ...
                            <br> تقاطع شارع 253 و205، 
                            <br> دجلة، المعادي، القاهرة، مصر. 
...
<!--                            <br> Or you can provide feedback and/or comments here: </p>-->
            ...
            <div id="contact-form" class="col-md-12 contact-form">

<!--                <div class="row">-->
                    <?php global $pageval; $pageval = "Contact_Ar"; include('form_page.php'); ?>
<!--                </div>-->
